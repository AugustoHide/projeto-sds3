...
import com.augusto.augustoVendas.service.SaleService;

@RestController //indica que classe é controllador rest
@RequestMapping(value = "/sales") //define caminho na url
